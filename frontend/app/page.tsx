...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button asChild size="lg" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-lg px-10 py-4 rounded-xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 transform hover:scale-105">
                <Link href="/signup">
                  Start Free Analysis
                  <ArrowRight className="ml-3 w-5 h-5" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" className="text-lg px-10 py-4 rounded-xl border-2 border-gray-400 text-gray-300 hover:bg-white hover:text-gray-900 bg-transparent backdrop-blur-sm transition-all duration-300">
      ...
      <section id="features" className="py-24 bg-gradient-to-b from-gray-50 to-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-blue-50 to-indigo-50 group">
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-green-50 to-emerald-50 group">
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <BarChart3 className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Policy Comparison</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-purple-50 to-violet-50 group">
              <CardContent className="p-8 text-center">
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-orange-50 to-amber-50 group">
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Shield className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Coverage Insights</h3>
                <p className="text-gray-600 leading-relaxed">
      ...
      <section id="demo" className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">How ClaimWise Works</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Insurance is confusing</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Claims get denied</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">You deserve clarity</h3>
                    <p className="text-gray-600">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">No sales pitch</h3>
                    <p className="text-gray-600">
                      We don't sell insurance. We just help you understand what you already have.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:pl-8">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to understand?</h3>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 via-blue-700 to-purple-700 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button asChild size="lg" variant="secondary" className="text-lg px-12 py-4 rounded-xl bg-white text-blue-700 hover:bg-gray-50 shadow-2xl hover:shadow-white/25 transition-all duration-300 transform hover:scale-105">
              <Link href="/signup">
                Start Free Analysis
                <ArrowRight className="ml-3 w-5 h-5" />
              </Link>
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="text-lg px-12 py-4 rounded-xl border-2 border-white/30 text-white hover:bg-white/10 bg-transparent backdrop-blur-sm transition-all duration-300 hover:border-white/50"
            >
